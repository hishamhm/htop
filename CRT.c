...
int CRT_colorSchemes[LAST_COLORSCHEME][LAST_COLORELEMENT] = {
   [COLORSCHEME_DEFAULT] = {
      ...
      [BATTERY_WARN] = ColorPair(Yellow,Black),
      [BATTERY_CRIT] = ColorPair(Red,Black),
   ...
   [COLORSCHEME_BLACKONWHITE] = {
      ...
      [BATTERY_WARN] = ColorPair(Yellow,White),
      [BATTERY_CRIT] = ColorPair(Yellow,White),
   ...
   [COLORSCHEME_LIGHTTERMINAL] = {
      ...
      [BATTERY_WARN] = ColorPair(Yellow,Black),
      [BATTERY_CRIT] = ColorPair(Yellow,Black),
   ...
   [COLORSCHEME_MIDNIGHT] = {
      ...
      [BATTERY_WARN] = A_BOLD | ColorPair(Yellow,Blue),
      [BATTERY_CRIT] = A_BOLD | ColorPair(Yellow,Blue),
