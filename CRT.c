...
int CRT_colorSchemes[LAST_COLORSCHEME][LAST_COLORELEMENT] = {
   [COLORSCHEME_DEFAULT] = {
      ...
      [ZSWAP_USED] = ColorPair(Green,Black),
      [ZSWAP_CACHED] = ColorPair(Green,Black),
   ...
   [COLORSCHEME_BLACKONWHITE] = {
      ...
      [ZSWAP_USED] = ColorPair(Green,White),
      [ZSWAP_CACHED] = ColorPair(Green,White),
   ...
   [COLORSCHEME_MIDNIGHT] = {
      ...
      [ZSWAP_USED] = ColorPair(Green,Blue),
      [ZSWAP_CACHED] = ColorPair(Green,Blue),
