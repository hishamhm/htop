...
int CRT_colorSchemes[LAST_COLORSCHEME][LAST_COLORELEMENT] = {
   [COLORSCHEME_DEFAULT] = {
      ...
      [GRAPH_1] = A_BOLD | ColorPair(Red,Black),
      [GRAPH_2] = A_BOLD | ColorPair(Yellow,Black),
      [GRAPH_3] = A_BOLD | ColorPair(Cyan,Black),
      [GRAPH_4] = A_BOLD | ColorPair(Green,Black),
   ...
   [COLORSCHEME_BLACKONWHITE] = {
      ...
      [GRAPH_3] = ColorPair(Blue,White),
      [GRAPH_4] = ColorPair(Blue,White),
   ...
   [COLORSCHEME_LIGHTTERMINAL] = {
      ...
      [GRAPH_3] = ColorPair(Cyan,Black),
      [GRAPH_4] = ColorPair(Cyan,Black),
      [MEMORY_USED] = ColorPair(Green,Black),
   ...
   [COLORSCHEME_MIDNIGHT] = {
      ...
      [GRAPH_3] = ColorPair(Cyan,Blue),
      [GRAPH_4] = ColorPair(Cyan,Blue),
   ...
   [COLORSCHEME_BLACKNIGHT] = {
      ...
      [GRAPH_3] = ColorPair(Green,Black),
      [GRAPH_4] = ColorPair(Green,Black),
      [MEMORY_USED] = ColorPair(Green,Black),
      [MEMORY_BUFFERS] = ColorPair(Blue,Black),
      [MEMORY_BUFFERS_TEXT] = A_BOLD | ColorPair(Blue,Black),
      [MEMORY_CACHE] = ColorPair(Yellow,Black),
